	...
	return (
		...
		<Modal open={true} closeIcon onClose={this.props.closeModal}>
			
			{
				...
				<Modal.Content>
					<Modal.Description>
						...
						<Form onSubmit={this.props.addBuilding}>
							...
							/>
							<Modal.Actions>
								<Button color="yellow" onClick={this.props.closeModal}>
									Cancel
								</Button>
								<Button
									color='green'
				...
				<Modal.Content>
					<Modal.Description>
						...
						<Form
							onSubmit={this.props.addBuilding}>
							<Label>Address:</Label>
							<Form.Input
								type="text"
								name="address"
...

			{
              this.state.action === "search"
              ?
              <small >Dont see your building? Add it <span onClick={this.switchForm}>here</span>.</small>
              :
              <small >Search for your building<span onClick={this.switchForm}>here</span>!</small>  
            }
